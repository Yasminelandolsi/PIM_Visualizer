...
const Footer = () => {
  ...
  const FooterSection = ({ title, children }: FooterSectionProps) => (
    <div className="w-full xl:w-auto">
      <h2 className="mb-3 text-custom-1 font-medium text-dark">{title}</h2>
  ...
  >
    <div className="w-full px-8">
      <div className="w-full flex-col flex xl:items-center">
        <div className="flex flex-wrap xl:flex-nowrap gap-4 xl:gap-19 xl:justify-between pt-3 pb-3 xl:pb-5">
          <div className="max-w-[330px] w-full">
            <h2 className="mb-3 text-custom-1  font-medium text-dark">
              Help & Support
            </h2>
        ...
        <p className="text-[#ffd700] font-medium py-1">
